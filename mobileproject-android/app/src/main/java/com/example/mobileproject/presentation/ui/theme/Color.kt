...
internal val MobileProjectLightColorScheme = lightColorScheme(
    ...
    onBackground = Color(0xFF5C5254),
    surface = Color(0xFFFFEBEF),
    onSurface = Color(0xFF5C5254),
    surfaceVariant = Color(0xFFF5E8EB),
    onSurfaceVariant = Color(0xFF6E6061),
    surfaceContainerLowest = Color(0xFFFFFFFF),
    surfaceContainerLow = Color(0xFFFFEBEF),
